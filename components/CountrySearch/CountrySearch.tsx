...
const CountrySearchItem = ({ item, selectItem }: {item: ExtendedCountry, selectItem: (item: ExtendedCountry) => void}) => {
    return (
...
const CountrySearch = ({ countriesList, onSelect }: CountrySearchProps) => {
    const [itemSelected, setItemSelected] = useState<ExtendedCountry | null>(null)
