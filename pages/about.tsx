    ...
    <MainLayout hideJumbotron>
      <div className={styles.wrapper}>
        <Container className={styles.container}>
          ...
          <p className="mt-4">
            שים eSim שמה לעצמה למטרה לספק חויית שירות איכותית וטובה, ולספק מבחר
            של אפשרויות רכישה במחירים כדאיים, של חבילות דאטא עבור גלישה בחו"ל
          </p>
          <p>
            התחלנו את דרכנו בשנת 2022, כאשר כשוחרי טיולים וכמי שנהנים לנסוע
            ולטייל בחו"ל, שמנו לב למחסור באפשררויות נוחות ובמחירים כדאיים עבור
            חבילות גלישה ושימוש בטלפון בזמן השהייה בחו"ל
          </p>
          <p>
            הטכנולוגיות החדשות קיצרו את הדרך ליוזמה להציע חבילות גלישה בחו"ל על
            בסיס כרטיס eSim, עליו ניתן להטעין מספר חבילות.
          </p>
          <p>
