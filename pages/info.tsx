...
const Info = () => (
  <MainLayout title="eSim" hideJumbotron>
      ...
      <Container className={styles.container}>
        ...
        <div className="mt-3">
          <p>
            ...
            הסלולר המקומית, ניתן כעת &quot;להתקנה&quot; פשוטה באמצעות סריקת קוד
            QR.
          </p>
          כרטיס eSim לחו&quot;ל נרשם במכשירכם באותה הצורה הפשוטה, באמצעות 3
          שלבים מהירים:
          <ol>
            <li>מזמינים חבילה</li>
          ...
          <p>
            ...
            לחו&quot;ל מאפשר לכם הפעלה פשוטה, באמצעות סריקת קוד QR, והפעלה
            וכיבוי מהירים.
          </p>
          <p className="mb-0">
            ...
            לגלישה בחו&quot;ל, בכל רחבי העולם. הזמנתם חבילה והיא נגמרה? תוכלו
            להטעין חבילה נוספת בקלות ובמהירות, באמצעות האזור האישי שלכם באתר,
            ללא צורך בהמתנה לנציג.
          </p>
        </div>
      </Container>
    </div>
