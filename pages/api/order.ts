        ...
        if (method === 'POST') {
            ...
            const plan = await prisma.plan.create({
                data: {
                    ...
                    payment: {
                        create: {
                            externalId: Math.floor(Math.random() * (999 - 100) + 100).toString(), // TODO: Get from payment gateway
            ...
            res.redirect(302, `http://localhost:3000/login?orderId=${plan.id}&phone=${newOrderData.phoneNumber}`)
