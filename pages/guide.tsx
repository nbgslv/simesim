        ...
        <Container className={styles.container}>
          ...
          <div className="mt-4">
            ...
            <p>
              ...
              בטכנולוגיית eSim, המפורסמת אצלנו באתר. עם זאת, מומלץ לבדוק את
              הגדרות המכשיר כדי לוודא שהמכשיר אכן תומך בטכנולוגיית eSim.
            </p>
            ...
            <ol>
              ...
              <li>
                אם חלק זה מציין שאין נעלת ספקים(No SIM restrictions), מכשירכם
                אינו נעול
              </li>
            </ol>
            <small>
              שימו לב: אם הטלפון שלכם נעול לספקים, לא תוכלו להחליף כרטיס סים
              לספק אחר או להשתמש בכרטיס eSim. תחילה עליכם לבטל את נעילת הספקים.
              לשם כך אנו ממליצים לפנות לספק המכשיר שלכם.
            </small>
            ...
            <ol>
              ...
              <li>
                אם תתבקשו לבחור באפשרות לסרוק קוד QR להפעלת הכרטיס, סימן
                שמכשירכם תומך בוודאות בטכנולוגיית eSim
              </li>
            </ol>
            <h3 className="mt-3 mb-2">עבור מכשירי Android</h3>
            <p>
              כדי לבדוק אם מכשיר האנדרואיד שלכם תומך ב-eSim עליכם לעקוב אחר מספר
              צעדים פשוטים שיפורטו מיד. עם זאת, חשוב להבין שכל חברה נוטה לשנות
              מעט את מערכת ההפעלה שהיא מציעה למשתמשיה ולפיכך יתכן גם שוני
              בתוויות שעל הכפתורים עליהם תצטרכו להקיש כדי לעקוב אחר הצעדים
              הבאים.
            </p>
            <h4 className="mt-3 mb-2">מכשירי Samsung</h4>
            <ol>
              <li>
                גשו להגדרות(Setting) -{'>'} חיבורים(Connections) -{'>'} מנהל
                כרטיס SIM(SIM Card Manager)
              </li>
              <li>
            ...
            <p>
              אם אתם לא בטוחים אם המכשיר שלכם אכן תומך בטכנולוגיית eSim, או
              שפשוט תרצו לוודא זאת, אנו מזמינים אתכם ליצור קשר עם צוות התמיכה
              המנוסה שלנו.
            </p>
