...
export default class KeepGoApi {
  ...
  public async getLines(
    ...
    try {
      ...
      const response = await fetch(
        `${this.baseUrl}/lines?${new URLSearchParams(params)}`,
        {
          headers: {
            ...this.authHeaders,
          },
  ...
  public async getAvailableRefills(
    id: string
  ): Promise<KeepGoResponse | Error> {
    try {
      const response = await fetch(
        `${this.baseUrl}/line/${id}/available_refills`,
        {
          headers: {
            ...this.authHeaders,
          },
  ...
  public async refillLine(
    id: string,
    data: { amountMb: number; amountDays: number }
  ): Promise<KeepGoResponse | Error> {
    try {
  ...
  public async updateDeactivationDate(
    id: string,
    ...
    try {
      ...
      const response = await fetch(
        `${this.baseUrl}/line/${id}/deactivation_date`,
        {
          method: 'PUT',
          headers: {
            ...this.authHeaders,
  ...
  public async getTransactionsByDateRange(
    ...
    try {
      const response = await fetch(
        `${this.baseUrl}/transactions?sort_field=${sortField}&sort_order=${sortOrder}&common_filter=${commonFilter}`,
        {
          headers: {
            ...this.authHeaders,
          },
